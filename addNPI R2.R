...
OBGYN_List <- read.csv("D:/muffly/Guido/OP_OBGYN.csv", stringsAsFactors = FALSE)
...
write.csv(OP_Name, "D:/muffly/data/OP_Name.csv",row.names = FALSE)
write.csv(Prescriber_Name, "D:/muffly/data/Prescriber_Name.csv",row.names = FALSE)
write.csv(OP,"d:/muffly/data/OP.csv",row.names = FALSE)
write.csv(Prescriber, "D:/muffly/data/Prescriber.csv",row.names = FALSE)
...
write.csv(unmatch_Dup,"D:/muffly/data/unmatch_dups.csv",row.names = FALSE)
write.csv(OP_Name_Matched, "D:/muffly/data/OP_Name_Matched.csv",row.names = FALSE)
write.csv(OP_Name_UnMatched, "D:/muffly/data/OP_Name_UnMatched.csv",row.names = FALSE)

write.csv(Prescriber_Name_Matched, "D:/muffly/data/Prescriber_Name_Matched.csv",row.names = FALSE)
write.csv(Prescriber_Name_UnMatched, "D:/muffly/data/Prescriber_Name_UnMatched.csv",row.names = FALSE)
...
write.csv(value, "D:/muffly/data/value.csv")
