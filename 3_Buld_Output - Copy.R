...
StudyGroup <- read.csv("C:/Users/jguido/Dropbox (Personal)/Pharma_Influence/Guido_Working_file/StudyGroupR2.csv", stringsAsFactors=FALSE)
...
T1 <- PaySum[PaySum$Class == classvar,c(11,10,4)]
...
T2 <- PaySum[PaySum$Class == classvar,c(11,10,4)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
...
T3 <- PaySum[PaySum$Class == classvar,c(11,10,4)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
...
T4 <- PaySum[PaySum$Class == classvar,c(11,10,4)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
...
T5 <- PaySum[PaySum$Class == classvar,c(11,10,4)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
...
T6 <- PaySum[PaySum$Class == classvar,c(11,10,4)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
...
T7 <- PaySum[PaySum$Class == classvar,c(11,10,4)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
...
T8 <- PaySum[PaySum$Class == classvar,c(11,10,4)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
...
classvar = "class_Anti_infective"
PR1 <- Prescriber[Prescriber$Class == classvar,c(1,8,5)]
...
classvar = "class_Anticholinergics_for_overactive_bladder"
PR2 <- Prescriber[Prescriber$Class == classvar,c(1,8,5)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
...
classvar = "class_Antiviral"
PR3 <- Prescriber[Prescriber$Class == classvar,c(1,8,5)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
...
classvar = "class_Bisphosphonates"
PR4 <- Prescriber[Prescriber$Class == classvar,c(1,8,5)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
...
classvar = "class_Hormone_therapy_single_ingredient_therapy"
PR5 <- Prescriber[Prescriber$Class == classvar,c(1,8,5)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
...
classvar = "class_Oral_Combined_Estrogen_and_Progestin_Products_for_Hormone_Therapy"
PR6 <- Prescriber[Prescriber$Class == classvar,c(1,8,5)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
...
classvar = "class_Transdermal_estrogen"
PR7 <- Prescriber[Prescriber$Class == classvar,c(1,8,5)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
...
classvar = "class_Vaginal_Estrogen_Hormone_Therapy"
PR8 <- Prescriber[Prescriber$Class == classvar,c(1,8,5)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
