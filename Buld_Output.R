...
#Load Data from prior step(s) - (LoadData)
...
Prescriber <- read.csv("C:/Users/jguido/Dropbox (Personal)/Pharma_Influence/Guido_Working_file/Prescriber.csv", header=TRUE, stringsAsFactors=FALSE)

#normalize column names, change drug names to lower case
names(PaySum) <- c("PPI", "ManName", "TotalPay","DrugName", "DrugNDC", "Year", "DrugCount" )
PaySum$DrugName <- tolower(PaySum$DrugName)

Prescriber <- Prescriber[,c(1,5,8,9,13,22)]
names(Prescriber) <- c("NPI","State", "Specialty", "DrugName", "GenericName", "TotalDaySupply", "Year")
...
class_Anti_infective <-c("metrogel","metronidazole","tinidazole")

class_Antiviral <-c("valtrex","zovirax")

class_Hormone_therapy_single_ingredient_therapy <-c("alora","cenestin","climara","depo-provera","enjuvia","medroxyprogesterone acetate","premarin","vivelle-dot")

class_Oral_Combined_Estrogen_and_Progestin_Products_for_Hormone_Therapy <-c("activella","amabelz","climara pro","combipatch","femhrt","menest","mimvey","mimvey lo","premphase","prempro")

class_Anticholinergics_for_overactive_bladder <-c("detrol","detrol la","ditropan","ditropan xl","enablex","gelnique","oxytrol","sanctura","sanctura xr","toviaz","vesicare")

class_Bisphosphonates <-c("atelvia","boniva","divigel","elestrin","fosamax","prolia","risedronate")

class_Transdermal_estrogen <-c("alora","climara","menostar","vivelle-dot")

class_Vaginal_Estrogen_Hormone_Therapy <-c("duavee","estrace","estring","intrarosa","menest","osphena","premarin","vagifem","yuvafem")
...
T1 <- PaySum[PaySum$Class == classvar,c(10,9,3)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
T1 <- merge(T1,Tx, all = TRUE)
T1 <- dcast(T1,NPI ~ Drug,sum,value.var = "TotalPay")
#T1 <- T1[T1$NPI != 0,]
...
T2 <- PaySum[PaySum$Class == classvar,c(10,9,3)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
T2 <- merge(T2,Tx, all = TRUE)
T2 <- dcast(T2,NPI ~ Drug,sum,value.var = "TotalPay")
#T2 <- T2[T2$NPI != 0,]
...
T3 <- PaySum[PaySum$Class == classvar,c(10,9,3)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
T3 <- merge(T3,Tx, all = TRUE)
T3 <- dcast(T3,NPI ~ Drug,sum,value.var = "TotalPay")
#T3 <- T3[T3$NPI != 0,]
...
T4 <- PaySum[PaySum$Class == classvar,c(10,9,3)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
T4 <- merge(T4,Tx, all = TRUE)
T4 <- dcast(T4,NPI ~ Drug,sum,value.var = "TotalPay")
#T4 <- T4[T4$NPI != 0,]
...
T5 <- PaySum[PaySum$Class == classvar,c(10,9,3)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
T5 <- merge(T5,Tx, all = TRUE)
T5 <- dcast(T5,NPI ~ Drug,sum,value.var = "TotalPay")
#T5 <- T5[T5$NPI != 0,]
...
T6 <- PaySum[PaySum$Class == classvar,c(10,9,3)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
T6 <- merge(T6,Tx, all = TRUE)
T6 <- dcast(T6,NPI ~ Drug,sum,value.var = "TotalPay")
#T6 <- T6[T6$NPI != 0,]
...
T7 <- PaySum[PaySum$Class == classvar,c(10,9,3)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
T7 <- merge(T7,Tx, all = TRUE)
T7 <- dcast(T7,NPI ~ Drug,sum,value.var = "TotalPay")
#T7 <- T7[T7$NPI != 0,]
...
T8 <- PaySum[PaySum$Class == classvar,c(10,9,3)]
Tx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
Tx$NPI <- 0
Tx$TotalPay <- 0 
Tx <- Tx[,c(3,2,4)]
T8 <- merge(T8,Tx, all = TRUE)
T8 <- dcast(T8,NPI ~ Drug,sum,value.var = "TotalPay")
#T8 <- T8[T8$NPI != 0,]
...
classvar = "class_Anti_infective"
PR1 <- Prescriber[Prescriber$Class == classvar,c(1,9,6)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
PR1 <- merge(PR1,PRx, all = TRUE)
PR1 <- dcast(PR1,NPI ~ Drug,sum,value.var = "TotalDaySupply")
#PR1 <- PR1[PR1$NPI != 0,]
...
classvar = "class_Anticholinergics_for_overactive_bladder"
PR2 <- Prescriber[Prescriber$Class == classvar,c(1,9,6)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
PR2 <- merge(PR2,PRx, all = TRUE)
PR2 <- dcast(PR2,NPI ~ Drug,sum,value.var = "TotalDaySupply")
#PR2 <- PR2[PR2$NPI != 0,]
...
classvar = "class_Antiviral"
PR3 <- Prescriber[Prescriber$Class == classvar,c(1,9,6)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
PR3 <- merge(PR3,PRx, all = TRUE)
PR3 <- dcast(PR3,NPI ~ Drug,sum,value.var = "TotalDaySupply")
#PR3 <- PR3[PR3$NPI != 0,]
...
classvar = "class_Bisphosphonates"
PR4 <- Prescriber[Prescriber$Class == classvar,c(1,9,6)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
PR4 <- merge(PR4,PRx, all = TRUE)
PR4 <- dcast(PR4,NPI ~ Drug,sum,value.var = "TotalDaySupply")
#PR4 <- PR4[PR4$NPI != 0,]
...
classvar = "class_Hormone_therapy_single_ingredient_therapy"
PR5 <- Prescriber[Prescriber$Class == classvar,c(1,9,6)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
PR5 <- merge(PR5,PRx, all = TRUE)
PR5 <- dcast(PR5,NPI ~ Drug,sum,value.var = "TotalDaySupply")
#PR5 <- PR5[PR5$NPI != 0,]
...
classvar = "class_Oral_Combined_Estrogen_and_Progestin_Products_for_Hormone_Therapy"
PR6 <- Prescriber[Prescriber$Class == classvar,c(1,9,6)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
PR6 <- merge(PR6,PRx, all = TRUE)
PR6 <- dcast(PR6,NPI ~ Drug,sum,value.var = "TotalDaySupply")
#PR6 <- PR6[PR6$NPI != 0,]
...
classvar = "class_Transdermal_estrogen"
PR7 <- Prescriber[Prescriber$Class == classvar,c(1,9,6)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
PR7 <- merge(PR7,PRx, all = TRUE)
PR7 <- dcast(PR7,NPI ~ Drug,sum,value.var = "TotalDaySupply")
#PR7 <- PR7[PR7$NPI != 0,]
...
classvar = "class_Vaginal_Estrogen_Hormone_Therapy"
PR8 <- Prescriber[Prescriber$Class == classvar,c(1,9,6)]
PRx <- Payment_Class[Payment_Class$Class == classvar,c(1,2)]
PRx$NPI <- 0
PRx$TotalDaySupply <- 0 
PRx <- PRx[,c(3,2,4)]
PR8 <- merge(PR8,PRx, all = TRUE)
PR8 <- dcast(PR8,NPI ~ Drug,sum,value.var = "TotalDaySupply")
#PR8 <- PR8[PR8$NPI != 0,]
...
names(T1)[2:4] <- paste("Pay_", names(T1)[2:4],sep="")
names(PR1)[2:4] <- paste("Pre_", names(PR1)[2:4],sep="")
T1p <- T1p[,c(4,1:3)]
...
names(T2)[2:12] <- paste("Pay_", names(T2)[2:12],sep="")
names(PR2)[2:12] <- paste("Pre_", names(PR2)[2:12],sep="")
T2p <- T2p[,c(12,1:11)]
...
names(T3)[2:3] <- paste("Pay_", names(T3)[2:3],sep="")
names(PR3)[2:3] <- paste("Pre_", names(PR3)[2:3],sep="")
T3p <- T3p[,c(3,1:2)]
...
names(T4)[2:8] <- paste("Pay_", names(T4)[2:8],sep="")
names(PR4)[2:8] <- paste("Pre_", names(PR4)[2:8],sep="")
T4p <- T4p[,c(8,1:7)]
...
names(T5)[2:9] <- paste("Pay_", names(T5)[2:9],sep="")
names(PR5)[2:9] <- paste("Pre_", names(PR5)[2:9],sep="")
T5p <- T5p[,c(9,1:8)]
...
names(T6)[2:11] <- paste("Pay_", names(T6)[2:11],sep="")
names(PR6)[2:11] <- paste("Pre_", names(PR6)[2:11],sep="")
T6p <- T6p[,c(11,1:10)]
...
names(T7)[2:5] <- paste("Pay_", names(T7)[2:5],sep="")
names(PR7)[2:5] <- paste("Pre_", names(PR7)[2:5],sep="")
T7p <- T7p[,c(5,1:4)]
...
names(T8)[2:10] <- paste("Pay_", names(T8)[2:10],sep="")
names(PR8)[2:10] <- paste("Pre_", names(PR8)[2:10],sep="")
T8p <- T8p[,c(10,1:9)]
